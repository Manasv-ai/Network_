...
class TrainingPipeline():
    ...
    def start_model_trainer(self,data_transformatin_artifact:DataTransformationArtifact)-> ModelTrainerArtifact:
        try:
            ...
            model_trainer=ModelTrainer(
                data_transformation_artifact=data_transformatin_artifact,
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer_artifact=self.model_trainer_config(data_transformation_artifact=data_transformation_artifact)
            return model_trainer_artifact
